...
function Card({ cardInfo }) {
  return (
    <div className="w-full shadow-xl  justify-between flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300">
      ...
      <h2 className="text-2xl font-bold text-center py-8">{cardInfo.title}</h2>
      <p className="text-center text-4xl font-bold">{cardInfo.subtitle}</p>
      ...
      <button
        ...
        type="button"
      >
        <a href="/#form" alt="go to newsletters">
          Plus d'informations
        </a>
      </button>
    </div>
