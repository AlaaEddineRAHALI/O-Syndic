...
const MyField = (props) => {
  console.log(props); // name: 'nom', className: 'p-3 w-full rounded-md text-black mb-3', onChange: ƒ
  // tu peux mettre les valeurs que tu souhaites récupérer dans le contexyte (email...)
  const {
    values: { code },
    setFieldValue,
  } = useFormikContext();
